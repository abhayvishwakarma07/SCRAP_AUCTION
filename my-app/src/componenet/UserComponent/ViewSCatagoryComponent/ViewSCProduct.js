      ...
      <div class="container-fluid  p-0 overflow-hidden " >
        <div class="row g-0">
          <div class="col-lg-12 py-6">
            <h1 class=" mb-4">View <span class="text-danger">Product SubCategory &gt;&gt; {params.catnm}</span></h1>
            <div id="category_main" className='d-flex flex-wrap justify-content-center' >
              {
                scList.map((row) => (
                  <Link to={`/subCategory/${row.subcatnm}`} className=''  >
                    <div class="category_part border border-black rounded-2 m-2 p-2 text-center bg-dark" style={{ "height": "350px", "width": "300px" }}>
